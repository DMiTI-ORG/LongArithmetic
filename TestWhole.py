...
from WholeNumber import NaturalNumber
...
class TestWhole(TestCase):
    ...
    @patch.object(NaturalNumber, 'add_one')
    def test_quotient(self, add_one, quotient, is_positive, abs):
        number_1 = WholeNumber(1, 2, [2, 0])
        number_2 = WholeNumber(1, 1, [5])
        number_3 = NaturalNumber(1, [5])
        ...
        add_one.return_value = NaturalNumber(1, [5])
